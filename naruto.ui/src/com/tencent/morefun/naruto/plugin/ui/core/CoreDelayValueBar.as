package com.tencent.morefun.naruto.plugin.ui.core
{
	...
	public class CoreDelayValueBar extends EventDispatcher
	{
		...
		public function CoreDelayValueBar(res:MovieClip)	
		{
			super();
		...
		public function update(curValue:int, maxValue:int, time:Number = 0.3):void
		{
			...
			TweenManager.killTweensOf(this);
			TweenManager.addTweenTo(this,time,{curRealValue:curValue, delay:0.2, onUpdate:onUpdate, onComplete:onComplete});
		}
