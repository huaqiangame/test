package com.tencent.morefun.naruto.plugin.ui.components.wrappers 
{
	...
	public class ButtonWrapper extends MovieClip
	{
		...
		public function ButtonWrapper(clipView:DisplayObject)
		{
			...
			if (!_clipView)
			{
				throw new ArgumentError(I18n.lang("as_ui_1451031579_6170_0") + this + I18n.lang("as_ui_1451031579_6170_1"));
			}
			...
			if (!_clipView.parent)
			{
				throw new ArgumentError(_clipView + I18n.lang("as_ui_1451031579_6171"));
			}
